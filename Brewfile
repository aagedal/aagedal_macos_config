...
## Command Line / Terminal Apps and tools
...
cask "font-meslo-lg-nerd-font" # Necessary for Wezterm Setup
...
## Blackmagic Design - DaVinci Resolve Studio – Can be automated via mas, but for python scripting it's best getting directly from Blackmagic Design.
